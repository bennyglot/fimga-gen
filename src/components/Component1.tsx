...
const Component: FunctionComponent<ComponentType> = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-end justify-between pt-[48.2px] px-[250px] pb-[71.6px] box-border relative max-w-full gap-[20px] z-[1] text-left text-21xl text-dark-blue-sw font-x-hp-title mq925:pl-[62px] mq925:pr-[62px] mq925:box-border mq1350:pl-[125px] mq1350:pr-[125px] mq1350:box-border mq1825:flex-wrap mq450:pt-[31px] mq450:pb-[47px] mq450:box-border ${className}`}
    >
