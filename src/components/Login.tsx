...
const Login: FunctionComponent<LoginType> = ({
  ...
  return (
    ...
    >
      <div className="relative shrink-0 z-[1]">{existingStarDoxUsersLogin}</div>
      <button className="cursor-pointer [border:none] pt-[9.8px] px-[26px] pb-[9.9px] bg-bluish-grey-sw rounded-xl flex flex-row items-start justify-start shrink-0 whitespace-nowrap z-[1] hover:bg-slategray">
