...
const ROIBottomBanner: FunctionComponent<ROIBottomBannerType> = ({
  ...
  return (
    <div
      className={`self-stretch flex flex-row items-start justify-start py-[35px] px-[249px] box-border relative min-h-[320px] max-w-full z-[2] text-left text-18xl text-light-background-sw font-x-hp-title mq925:pl-[62px] mq925:pr-[62px] mq925:box-border mq1350:pl-[124px] mq1350:pr-[124px] mq1350:box-border mq450:pl-5 mq450:pr-5 mq450:box-border ${className}`}
    >
      <img
      ...
      <div className="w-[701px] flex flex-col items-start justify-start gap-[26px] max-w-full z-[1]">
        <div className="self-stretch flex flex-row items-start justify-start py-0 pr-0 pl-px box-border max-w-full">
          <div className="flex-1 flex flex-col items-start justify-start gap-[2px] max-w-full">
            <h1 className="m-0 self-stretch relative text-inherit tracking-[-0.02em] leading-[60px] font-semibold font-inherit mq925:text-11xl mq925:leading-[48px] mq450:text-3xl mq450:leading-[36px]">
              See ROI in 12 weeks
            </h1>
